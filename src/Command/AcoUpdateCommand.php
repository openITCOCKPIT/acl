 ...
 * AcoUpdate command.
 */
class AcoUpdateCommand extends Command {
    /**
     * AclExtras instance
     *
     * @var \Acl\AclExtras
     ...
     * @var string
     */
    protected string $name = 'aco_update';
    ...
    public static function getDescription(): string {
        return 'Add new ACOs for new controllers and actions. Does not remove nodes from the ACO table.';
    }
